...
<head>
    ...
    <title>Adm - Visualizar Pedido</title>
</head>
<body>
      ...
      <div class="container">
        ...
        <form method="post">
          ...
          <div class="row">
            ...
            <?php if($pedido[0]['status_tb_venda'] == '0'){?><a href="#" id="bCanPedAdm" name="bProCan" class="btn btn-black btn-lg btn-radius"><i class="bi bi-x-circle-fill"></i> Cancelar</a><?php }?>
            </div>
